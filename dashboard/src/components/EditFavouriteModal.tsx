...
function EditFavouriteModal({
  ...
  useEffect(() => {
    if (favourite) {
      ...
      setActionType(favourite.actionType);
      setUrl(favourite.url || "");
      setModalOptions(favourite.modalOptions || "");
      setOrder(favourite.order);
      setIsActive(favourite.isActive);
      setImagePreview(`http://localhost:8000${favourite.image}`);
    }
  }, [favourite]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/api/favourites/${favourite._id}`,
        {
          method: "PUT",
          headers: {
      ...
      console.log("Favourite updated successfully:", data);
    ...
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h2 className="modal-title">Edit Favourite</h2>
          <button
