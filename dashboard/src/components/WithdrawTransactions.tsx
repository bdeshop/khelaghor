...
import "./WithdrawTransactions.css";
...
const WithdrawTransactions = () => {
    ...
    try {
      ...
      const url =
        statusFilter === "all"
          ...
          : `${API_URL}/withdraw-transactions/admin/all?status=${statusFilter}`;
  ...
  const fetchStatistics = async () => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/withdraw-transactions/admin/statistics`,
        {
          headers: { Authorization: `Bearer ${authToken}` },
        }
      );
  ...
  const handleViewDetails = (transactionId: string) => {
    navigate(`/withdraw-transactions/${transactionId}`);
  };
  ...
  return (
    <div className="withdraw-transactions-container">
      <div className="page-header">
        <div>
          <h2 className="page-title">Withdraw Transactions</h2>
        ...
        <div className="stats-grid">
          ...
          <div className="stat-card primary">
            ...
            <div className="stat-info">
              ...
              <div className="stat-value">
                ${(statistics.totalWithdrawnAmount || 0).toFixed(2)}
              </div>
            </div>
          </div>
          <div className="stat-card info">
            ...
            <div className="stat-info">
              ...
              <div className="stat-value">
                ${(statistics.totalFeesCollected || 0).toFixed(2)}
              </div>
            </div>
          </div>
        </div>
